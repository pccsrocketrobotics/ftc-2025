...
@Config
public class SofiaTest extends LinearOpMode {
    ...
    protected Pose ballPickingPose1 = new Pose(12.7,32.8,Math.toRadians(90));
    protected Pose ballPickingPose2 = new Pose(12.7,18,Math.toRadians(90));
    protected Pose ballAlignPose1 = new Pose(7,18,Math.toRadians(90));
    protected Pose ballAlignPose2 = new Pose(7,18,Math.toRadians(90));
    ...
    public void runOpMode() {
        ...
        PathChain ballPickPath = follower.pathBuilder()
                .addPath(new BezierLine(halfShotPose, ballPickingPose1))
        ...
        PathChain secondBallPath = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(ballAlignPose2.getHeading(), halfShotPose.getHeading())
                .build();
